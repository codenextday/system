...
#define HAL_DEVID_CAM_1    	0x01000000  //!< CAM1
#define HAL_DEVID_CAMPHY_1 	0x02000000  //!< CAMPHY1, not neccessarily the PHY that CAM1 is hooked up to; see @ref HAL_DEVID_CAM_1_PHY instead
 ...
 *****************************************************************************/
#define HAL_I2C_BUS_CAM_1      	1 //!< Num of I2C bus CAM1 is connected to
