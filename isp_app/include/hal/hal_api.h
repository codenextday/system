...
/*add function need be optimization with phy and sensor*/
/*need to optimization after all hal function finish*/
RESULT HalSensorReset( HalHandle_t HalHandle, uint32_t dev_mask, bool_t activate );
