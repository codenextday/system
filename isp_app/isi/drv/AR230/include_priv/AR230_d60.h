 ...
 * - @ref module_name
 *
 * @defgroup AR230_D60   Illumination Profile D60
 * @{
 *
 */
#ifndef __AR230_D60_H__
#define __AR230_D60_H__
...
// crosstalk matrix
const Isi3x3FloatMatrix_t  AR230_XTalkCoeff_day =
{
    {
...
const IsiXTalkFloatOffset_t AR230_XTalkOffset_day =
{
    .fCtOffsetRed      = 0.0f,
    .fCtOffsetGreen    = 0.0f,
    .fCtOffsetBlue     = 0.0f
...
// gain matrix
const IsiComponentGain_t AR230_CompGain_day =
{
    .fRed      = 1.49016f,
    .fGreenR   = 1.00000f,
    .fGreenB   = 1.00000f,
...
const Isi2x1FloatMatrix_t AR230_GaussMeanValue_day =
{
    {
        0.09749f, -0.01594f 
    }
...
const Isi2x2FloatMatrix_t AR230_CovarianceMatrix_day =
{
    {
...
const IsiSaturationCurve_t AR230_SaturationCurve_day =
{
...
IsiSatCcMatrix_t AR230_SatCcMatrix_day[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t AR230_CcMatrixTable_day =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcMatrix    = &AR230_SatCcMatrix_day[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t AR230_SatCcOffset_day[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t AR230_CcOffsetTable_day=
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcOffset    = &AR230_SatCcOffset_day[0]
};
...
const IsiVignettingCurve_t AR230_VignettingCurve_day =
{
...
IsiVignLscMatrix_t AR230_VignLscMatrix_day[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
const IsiLscMatrixTable_t AR230_LscMatrixTable_day = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &AR230_VignLscMatrix_day[0]
};
