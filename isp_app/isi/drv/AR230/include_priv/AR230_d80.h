 ...
 * - @ref module_name
 *
 * @defgroup AR230_d80   Illumination Profile D80
 * @{
 *
 */
#ifndef __AR230_D80_H__
#define __AR230_D80_H__
...
/*****************************************************************************/
// crosstalk matrix
const Isi3x3FloatMatrix_t  AR230_XTalkCoeff_shade =
{
    {
...
const IsiXTalkFloatOffset_t AR230_XTalkOffset_shade =
{
    .fCtOffsetRed      = 0.0f,
    .fCtOffsetGreen    = 0.0f,
    .fCtOffsetBlue     = 0.0f
...
// gain matrix
const IsiComponentGain_t AR230_CompGain_shade =
{
...
const Isi2x1FloatMatrix_t AR230_GaussMeanValue_shade =
{
    {
        0.12818f, -0.00744f
    }
...
const Isi2x2FloatMatrix_t AR230_CovarianceMatrix_shade =
{
    {
...
const IsiGaussFactor_t AR230_GaussFactor_shade =
{
    .fGaussFactor = 163.91219f
};

// thresholds for switching between MAP classification and interpolation
const Isi2x1FloatMatrix_t AR230_Threshold_shade =
{
    {
...
const IsiSaturationCurve_t AR230_SaturationCurve_shade =
{
...
IsiSatCcMatrix_t AR230_SatCcMatrix_shade[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t AR230_CcMatrixTable_shade =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcMatrix    = &AR230_SatCcMatrix_shade[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t AR230_SatCcOffset_shade[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t AR230_CcOffsetTable_shade=
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcOffset    = &AR230_SatCcOffset_shade[0]
};
...
const IsiVignettingCurve_t AR230_VignettingCurve_shade =
{
...
IsiVignLscMatrix_t AR230_VignLscMatrix_shade[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
const IsiLscMatrixTable_t AR230_LscMatrixTable_shade = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &AR230_VignLscMatrix_shade[0]
};
