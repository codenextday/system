 ...
 * - @ref module_name
 *
 * @defgroup AR330_a   Illumination Profile A
 * @{
 *
 */
#ifndef __AR330_A_H__
#define __AR330_A_H__
...
/*****************************************************************************/
// crosstalk matrix
const Isi3x3FloatMatrix_t  AR330_XTalkCoeff_CIE_A =
{
    {
...
const IsiXTalkFloatOffset_t AR330_XTalkOffset_CIE_A =
{
    .fCtOffsetRed      = 0.0f,
    .fCtOffsetGreen    = 0.0f,
    .fCtOffsetBlue     = 0.0f
...
// gain matrix
const IsiComponentGain_t AR330_CompGain_CIE_A =
{
    .fRed      = 1.01927f,
    .fGreenR   = 1.00000f,
    .fGreenB   = 1.00000f,
...
const Isi2x1FloatMatrix_t AR330_GaussMeanValue_CIE_A =
{
    {
	    -0.08479f,  -0.00744f 
    }
...
const Isi2x2FloatMatrix_t AR330_CovarianceMatrix_CIE_A =
{
    {
...
const IsiGaussFactor_t AR330_GaussFactor_CIE_A =
 {
    .fGaussFactor = 355.21868f 
 };

// thresholds for switching between MAP classification and interpolation
const Isi2x1FloatMatrix_t AR330_Threshold_CIE_A =
{
    {
	    0.65000f,  0.80000f  
    }
...
const IsiSaturationCurve_t AR330_SaturationCurve_CIE_A =
{
...
IsiSatCcMatrix_t AR330_SatCcMatrix_CIE_A[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t AR330_CcMatrixTable_CIE_A =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcMatrix    = &AR330_SatCcMatrix_CIE_A[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t AR330_SatCcOffset_CIE_A[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t AR330_CcOffsetTable_CIE_A =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcOffset    = &AR330_SatCcOffset_CIE_A[0]
};
...
const IsiVignettingCurve_t AR330_VignettingCurve_CIE_A =
{
...
IsiVignLscMatrix_t AR330_VignLscMatrix_CIE_A_1280x720[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
IsiLscMatrixTable_t AR330_LscMatrixTable_CIE_A_1280x720 = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &AR330_VignLscMatrix_CIE_A_1280x720[0],
...
IsiVignLscMatrix_t AR330_VignLscMatrix_CIE_A_1920x1080[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
IsiLscMatrixTable_t AR330_LscMatrixTable_CIE_A_1920x1080 = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &AR330_VignLscMatrix_CIE_A_1920x1080[0],
...
// vignetting dependend lsc matrices ( 1080pXX  1920x1080 )
IsiVignLscMatrix_t AR330_VignLscMatrix_CIE_A_2592x1944[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
IsiLscMatrixTable_t AR330_LscMatrixTable_CIE_A_2592x1944 = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &AR330_VignLscMatrix_CIE_A_2592x1944[0],
