 ...
 * - @ref module_name
 *
 * @defgroup AR330_d50   Illumination Profile D50
 * @{
 *
 */
#ifndef __AR330_D50_H__
#define __AR330_D50_H__
...
// crosstalk matrix
const Isi3x3FloatMatrix_t  AR330_XTalkCoeff_sunny =
{
    {
...
const IsiXTalkFloatOffset_t AR330_XTalkOffset_sunny =
{
    .fCtOffsetRed      = 0.0f,
    .fCtOffsetGreen    = 0.0f,
    .fCtOffsetBlue     = 0.0f
...
// gain matrix
const IsiComponentGain_t AR330_CompGain_sunny =
{
    .fRed      = 1.43113f,
    .fGreenR   = 1.00000f,
    .fGreenB   = 1.00000f,
...
const Isi2x1FloatMatrix_t AR330_GaussMeanValue_sunny =
{
    {
        0.07488f,  -0.01908f 
    }
...
const Isi2x2FloatMatrix_t AR330_CovarianceMatrix_sunny =
{
    {
...
const IsiGaussFactor_t AR330_GaussFactor_sunny =
{
    .fGaussFactor = 193.28137f
};

// thresholds for switching between MAP classification and interpolation
const Isi2x1FloatMatrix_t AR330_Threshold_sunny =
{
    {
...
const IsiSaturationCurve_t AR330_SaturationCurve_sunny =
{
...
IsiSatCcMatrix_t AR330_SatCcMatrix_sunny[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t AR330_CcMatrixTable_sunny =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcMatrix    = &AR330_SatCcMatrix_sunny[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t AR330_SatCcOffset_sunny[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t AR330_CcOffsetTable_sunny=
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcOffset    = &AR330_SatCcOffset_sunny[0]
};
...
const IsiVignettingCurve_t AR330_VignettingCurve_sunny =
{
...
IsiVignLscMatrix_t AR330_VignLscMatrix_sunny[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
const IsiLscMatrixTable_t AR330_LscMatrixTable_sunny = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &AR330_VignLscMatrix_sunny[0]
};
