 ...
 * - @ref module_name
 *
 * @defgroup AR330_d80   Illumination Profile D80
 * @{
 *
 */
#ifndef __AR330_D80_H__
#define __AR330_D80_H__
...
/*****************************************************************************/
// crosstalk matrix
const Isi3x3FloatMatrix_t  AR330_XTalkCoeff_shade =
{
    {
...
const IsiXTalkFloatOffset_t AR330_XTalkOffset_shade =
{
    .fCtOffsetRed      = 0.0f,
    .fCtOffsetGreen    = 0.0f,
    .fCtOffsetBlue     = 0.0f
...
// gain matrix
const IsiComponentGain_t AR330_CompGain_shade =
{
...
const Isi2x1FloatMatrix_t AR330_GaussMeanValue_shade =
{
    {
        0.12818f, -0.00744f
    }
...
const Isi2x2FloatMatrix_t AR330_CovarianceMatrix_shade =
{
    {
...
const IsiGaussFactor_t AR330_GaussFactor_shade =
{
    .fGaussFactor = 163.91219f
};

// thresholds for switching between MAP classification and interpolation
const Isi2x1FloatMatrix_t AR330_Threshold_shade =
{
    {
...
const IsiSaturationCurve_t AR330_SaturationCurve_shade =
{
...
IsiSatCcMatrix_t AR330_SatCcMatrix_shade[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t AR330_CcMatrixTable_shade =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcMatrix    = &AR330_SatCcMatrix_shade[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t AR330_SatCcOffset_shade[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t AR330_CcOffsetTable_shade=
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcOffset    = &AR330_SatCcOffset_shade[0]
};
...
const IsiVignettingCurve_t AR330_VignettingCurve_shade =
{
...
IsiVignLscMatrix_t AR330_VignLscMatrix_shade[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
const IsiLscMatrixTable_t AR330_LscMatrixTable_shade = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &AR330_VignLscMatrix_shade[0]
};
