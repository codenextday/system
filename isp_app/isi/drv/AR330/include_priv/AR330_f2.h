 ...
 * - @ref module_name
 *
 * @defgroup AR330_F2   Illumination Profile F2
 * @{
 *
 */
#ifndef __AR330_F2_H__
#define __AR330_F2_H__
...
// crosstalk matrix
const Isi3x3FloatMatrix_t  AR330_XTalkCoeff_F2 =
{
    {
...
const IsiXTalkFloatOffset_t AR330_XTalkOffset_F2 =
{
    .fCtOffsetRed      = 0.0f,
    .fCtOffsetGreen    = 0.0f,
    .fCtOffsetBlue     = 0.0f
...
// gain matrix
const IsiComponentGain_t AR330_CompGain_F2 =
{
...
const Isi2x1FloatMatrix_t AR330_GaussMeanValue_F2 =
{
    {
        -0.01502f,  -0.03556f
    }
...
const Isi2x2FloatMatrix_t AR330_CovarianceMatrix_F2 =
{
    {
...
const IsiSaturationCurve_t AR330_SaturationCurve_F2 =
{
...
IsiSatCcMatrix_t AR330_SatCcMatrix_F2[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t AR330_CcMatrixTable_F2 =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcMatrix    = &AR330_SatCcMatrix_F2[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t AR330_SatCcOffset_F2[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t AR330_CcOffsetTable_F2=
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcOffset    = &AR330_SatCcOffset_F2[0]
};
...
const IsiVignettingCurve_t AR330_VignettingCurve_F2 =
{
...
IsiVignLscMatrix_t AR330_VignLscMatrix_F2[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
const IsiLscMatrixTable_t AR330_LscMatrixTable_F2 = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &AR330_VignLscMatrix_F2[0]
};
