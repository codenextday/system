...
#define AR330_Test_Pattern        (0x3070)  //val 0:No test pattern; 1: solid color; 2:Vertical color bar;
											//3:Fade to Gray Vertical color bar; 256: walking 1s test pattern;
#define AR330_DGC_ENA             (0x30BA) // R0X30BA[5] Bit5=1 use digtal gain; default is 0

#define AR330_AGC                (0x3060) // R0X3060[3:0]:fine gain; 0,2,4,6,8,10
