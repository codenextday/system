...
typedef RESULT (IsiGetSensorIsiVer_t)               ( IsiSensorHandle_t handle, unsigned int* pVersion );
typedef RESULT (IsiGetSensorTuningXmlVersion_t)     ( IsiSensorHandle_t handle, char** pTuningXmlVersion);
typedef RESULT (IsiWhiteBalanceIlluminationChk_t)   ( IsiSensorHandle_t handle, char *name );
typedef RESULT (IsiWhiteBalanceIlluminationSet_t)   ( IsiSensorHandle_t handle, char *name );
...
typedef struct sensor_i2c_info_s{
    ...
    unsigned int sensor_drv_version;
}sensor_i2c_info_t;
