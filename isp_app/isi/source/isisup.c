...
)
{
    ...
    result = HalWriteI2CMem( pSensorCtx->HalHandle, 
                                ...
                                NrOfDataBytes );
#else
    result = HalI2CWrite( pSensorCtx->HalHandle, 
                                pSensorCtx->I2cBusNum, 
                                pSensorCtx->SlaveAddress, 
                                RegAddress, 
                                pSensorCtx->NrOfAddressBytes, 
...
)
{
    ...
    printf("I2cBusNum %d, SlaveAddress 0x%x, RegAddress 0x%x\n", pSensorCtx->I2cBusNum, pSensorCtx->SlaveAddress, RegAddress);
...
)
{
    ...
    result = HalI2CRead( pSensorCtx->HalHandle, 
                            pSensorCtx->I2cBusNum, 
                            pSensorCtx->SlaveAddress, 
                            RegAddress, 
                            pSensorCtx->NrOfAddressBytes, 
