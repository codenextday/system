...
#define QT_BUILD_KEY "arm linux hjimi-gnueabi-g++ no-pkg-config"
#define QT_BUILD_KEY_COMPAT3 "armv6 linux hjimi-gnueabi-g++ no-pkg-config"
...
#if defined(QT_XML) && defined(QT_NO_XML)
# undef QT_XML
#elif !defined(QT_XML) && !defined(QT_NO_XML)
# define QT_XML
#endif
